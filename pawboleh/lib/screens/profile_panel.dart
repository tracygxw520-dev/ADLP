...
class _ProfilePanelState extends State<ProfilePanel> {
  ...
  Widget build(BuildContext context) {
    return _PanelSurface(
      child: Column(
        children: [
          _PanelHeader(title: 'Profile', onClose: () => Navigator.of(context).pop()),
          ...
          Container(
            ...
            child: Text('KA', style: AppTextStyles.cardTitle.copyWith(color: Colors.white)),
          ),
          ...
          GlassCard(
            ...
            child: Column(
              children: [
                _InfoRow(icon: Icons.alternate_email_rounded, label: 'Account', value: 'kirana@atelier.my'),
                const Divider(height: AppSpacing.lg),
                _InfoRow(icon: Icons.workspace_premium_rounded, label: 'Plan', value: 'PawBoleh Starter'),
              ],
            ),
          ),
          const SizedBox(height: AppSpacing.md),
          GlassCard(
            ...
            child: SwitchListTile.adaptive(
              ...
              title: Text('Paw Live reminders', style: AppTextStyles.sectionLabel),
              subtitle: Text('Keep upcoming livestream cues on', style: AppTextStyles.cardSubtitle),
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: DecoratedBox(
        ...
        child: SafeArea(child: Padding(padding: const EdgeInsets.all(AppSpacing.lg), child: child)),
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Text(value, style: AppTextStyles.chipLabel.copyWith(color: AppColors.textPrimary.withValues(alpha: 0.6))),
      ],
    );
  }
}
